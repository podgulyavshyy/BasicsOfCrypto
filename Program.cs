while (true)
{
 ...
 var filepath = "otpfile1.txt"; //Console.ReadLine();
 ...
 for (var i = 1; i <= 26; i++)
 {
  keyDifferenceDict.Add(i,Analyze(Decrypt(i, letterFrequencyDict),toCompare));
 }
 var answer = keyDifferenceDict.Aggregate((l, r) => l.Value < r.Value ? l : r).Key;
...
SortedDictionary<char,int> Decrypt(int key, SortedDictionary<char, int> letterFrequencyDict)
{
